...
public class Keyword extends AppCompatActivity {
    ...
    int[] keyword_point_arr = {1,1,1,0,1,1,1,1,1,1,0};

    RangeSlider rangeSlider_dessert,rangeSlider_various,rangeSlider_special,rangeSlider_size,
            rangeSlider_Landscape,rangeSlider_concentration,rangeSlider_trendy,rangeSlider_unique,rangeSlider_price;
    CheckBox check_parking, check_gift;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rangeSlider_unique = findViewById(R.id.rangeSlider_unique);
        rangeSlider_price = findViewById(R.id.rangeSlider_price);
        ...
        rangeSlider_unique.addOnSliderTouchListener(rangeSliderTouchListener_unique);
        rangeSlider_price.addOnSliderTouchListener(rangeSliderTouchListener_price);

        btn_next_keyword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if(keyword_point_arr[0]+keyword_point_arr[1]+keyword_point_arr[2]<=6&&keyword_point_arr[4]+keyword_point_arr[5]<=4
                &&keyword_point_arr[7]+keyword_point_arr[8]<=4){

                    if(check_parking.isChecked()){
                        keyword_point_arr[3]=1;
                    }
                ...
                else if(keyword_point_arr[0]+keyword_point_arr[1]+keyword_point_arr[2]>6){
                ...
                else if(keyword_point_arr[7]+keyword_point_arr[8]>4){
                    Toast.makeText(getApplicationContext(),"Trendy_store, Unique_store의 총합이 4 이하여야 합니다.",Toast.LENGTH_SHORT).show();
                }
...
//                    Log.d("DualThumbSeekbar ", "onStopTrackingTouch minPrice : " + minVal);
    ...
    private final RangeSlider.OnSliderTouchListener rangeSliderTouchListener_unique =
            new RangeSlider.OnSliderTouchListener() {
                @Override
                public void onStartTrackingTouch(RangeSlider slider) {
//                    바가 시작하면 동작하는 부분
...
//                    Log.d("DualThumbSeekbar ", "onStopTrackingTouch minPrice : " + minVal);
    ...
    private final RangeSlider.OnSliderTouchListener rangeSliderTouchListener_price =
            new RangeSlider.OnSliderTouchListener() {
                @Override
                public void onStartTrackingTouch(RangeSlider slider) {
//                    바가 시작하면 동작하는 부분
