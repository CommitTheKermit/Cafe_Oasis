...
input_file = "cafe_name_big1.csv"
output_file = "cafe_url_big1.csv"
    ...
    try:
        ...
        for element in elements:
            ...
            if element.text == "업체":
                ...
                urllib.request.urlretrieve(img_url, f'image{count}_001.jpg') #이미지 다운로드
                ...
                file.SetContentFile(f"image{count}_001.jpg")  # Set content of the file from given local path
                file.Upload()
